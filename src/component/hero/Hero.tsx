  ...
  return (
    <div className="p-6 md:p-10 w-full flex flex-col md:flex-row gap-4 min-h-[90vh]">
      <div className="w-full md:w-1/2 flex flex-col justify-center">
        <div className="text-md md:text-lg font-secondary">Hi, My name is</div>
        ...
        <div className="text-md md:text-xl font-secondary">
          <RevealAnimation>
      ...
      <div className="w-full md:w-1/2 bg-transparent flex justify-center items-start">
        <RevealAnimation rightToLeft={true}>
          <img src={Dop} alt="profile" className={`${darkMode ? 'opacity-50' : 'opacity-75'} object-cover md:px-10`} />
        </RevealAnimation>
      </div>
    </div>
  );
