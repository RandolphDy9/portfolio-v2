const Hero = () => {
  return (
    <div className="p-10 w-full flex gap-4 border-t border-b min-h-[90vh]">
      <div className="w-1/2 flex flex-col justify-center">
        <div className="text-lg font-secondary">Hi, My name is</div>
        <div className="text-7xl font-main my-2 font-bold">Randolph Mayson Dy</div>
        ...
        <div className="flex flex-row">
          <div className="text-xl my-2 border px-4 py-2 rounded-lg">Contact Me</div>
        </div>
      </div>
