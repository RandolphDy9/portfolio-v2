      ...
      <MainLayout darkMode={darkMode}>
        <div className="flex flex-col w-full m-6 md:m-12">
          ...
          <div className="text-3xl md:text-6xl text-center md:pt-28 py-16">
            <RevealAnimation>About Me</RevealAnimation>
          </div>
          <RevealAnimation>
          ...
          <div className="flex flex-col gap-8 md:w-4/5 mx-auto">
            <div className="">
              ...
              <div className="my-4">
                <RevealAnimation>
                  Verified International Academic Qualifications certificate
                  holder from World Education Services (WES)
                </RevealAnimation>
                <RevealAnimation>
                  <br />
                ...
                <RevealAnimation>
                  <br />
                  <br />
                  What sets me apart as a Frontend Developer is my innate
                  ability to thrive in collaborative environments. I am a
                  natural bridge-builder, adept at forming seamless connections
                  with diverse teams, whether it's coordinating harmoniously
                  with backend developers to ensure the flawless functionality
                  of web applications or collaborating closely with UI designers
                  to bring artistic visions to life. This collaborative spirit
                  fuels a constant flow of innovative ideas, fostering an
                  environment where collective creativity flourishes and
                  projects are driven toward the pinnacle of excellence.
                </RevealAnimation>
                <RevealAnimation>
                  <br />
                  <br />
                  In summary, I am not just a dedicated Frontend Developer, but
                  a passionate advocate for web development and a collaborative
