  ...
  return (
    <div className="flex flex-row justify-between min-h-screen overflow-hidden">
      ...
      <div className="flex-col gap-7 fixed left-12 top-1/2 transform -translate-y-1/2 items-center hidden md:flex">
        ...
        <img src={`${darkMode ? LinkedinWhite : LinkedinBlack}`} alt="linkedin-icon" width="26" className="cursor-pointer hover:scale-125" onClick={() => window.open('https://codepen.io/Randolph-Mayson-Dy', '_blank')} />
      </div>
